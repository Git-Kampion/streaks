...
from selenium.webdriver.chrome.options import Options  # Changed from Firefox to Chrome
from selenium.webdriver.chrome.service import Service  # Added for Chrome

# --- Paths (relative to repo root) ---
ROOT = Path(__file__).resolve().parent
DB1 = ROOT / "db" / "2026.accdb"
DB2 = ROOT / "db" / "2026.accdb"
...
browser = webdriver.Chrome(options=options)  # Changed to Chrome
