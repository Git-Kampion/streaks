...
def createReport(data1,pd):
 ...
 #with pd.ExcelWriter('awaystreaks.xlsx') as writer:
  ...
  df.to_excel('StreaksAwayinfo.xlsx', sheet_name="Away", index=False)
  #for ee in data1:
