...
"UNION select * from  CroatiaA25 UNION select * from SwitzerA25 UNION select * from  CroatiaB25  UNION select * from Austria225 UNION select * from belgiumJpl25   UNION select * from BrazilA25 UNION select * from BulgariaPrem25 UNION select * from Bundas2Liga25 UNION select * from Bundes325 UNION select * from CroatiaA25 UNION select * from CSuper25 UNION select * from CzechA25 UNION select * from CzechB25 UNION select * from DenmarkA25 UNION select * from DenmarkB25 UNION select * from EngLeagua225 UNION select * from EngLeagua125 UNION select * from EstoniaPrem25  UNION select * from irelandPrem25 UNION select * from JordanPrem25 UNION select * from PolandA25 UNION select * from PolandB25 UNION select * from RomaniA25  UNION select * from SlovakiaB25 UNION select * from SwedenB25  UNION select * from SwedenA25 UNION select * from SwissChalleng25 UNION select * from UkraineA25 UNION select * from UkrainePresha25 UNION select * from SloveniaA2025" 
...
def createReport(data1,pd):
 ...
 #with pd.ExcelWriter('awaystreaks.xlsx') as writer:
  ...
  df.to_excel('Streakshominfo2.xlsx', sheet_name="Home", index=False)
  #for ee in data1:
