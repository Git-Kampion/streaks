...
cursor = conn.cursor()
#insert_stmt2 = "select * from PeruA25  UNION select * from icelandBesta25 UNION select * from csuper25 UNION select * from CzechA25 UNION select * from SlovakiaA25 UNION select * from SlovakiaB25 UNION select * from SwedenA25 UNION select * from SwedenB25 UNION select * from BrazilA25 UNION select * from SwissChalleng25 UNION select * from SwitzerA25 UNION select * from QaterPrem25 UNION select * from UkrainePresha25 UNION select * from UkraineA25 UNION select * from serieBB25 UNION select * from Ligue2Fr25 UNION select * from Ligue1FrNat25 UNION select * from Ligue1Fr25 UNION select * from BundasLiga25 UNION select * from Bundas2Liga25 UNION select * from Bundes325 UNION select * from Laliga25 UNION select * from Laliga225 UNION select * from Epl25 UNION select * from MalaysiaPrem25 UNION select * from BulgariaPrem25 UNION select * from belgiumJpl25 UNION select * from BelgiumChall25 UNION select * from serieBB25  UNION select * from NorwayA25 UNION select * from SaudiPrem25 UNION select * from PolandA25 UNION select * from PolandB25 UNION select * from SerbiaA25 UNION select * from DenmarkA25 UNION select * from DenmarkB25" 

#insert_stmt2 = "select * from csuper25 ORDER BY Tframe Desc"
#insert_stmt2 = "select * from Laliga225 UNION select * from CzechB25 UNION select * from CzechA25 UNION select * from EredevisieTwede25 UNION select * from Eredevisie25 UNION select * from EersteEredevisie25  UNION select * from SwissChalleng25 UNION select * from SwitzerA25 UNION select * from QaterPrem25 UNION select * from UkrainePresha25 UNION select * from UkraineA25 UNION select * from serieBB25 UNION select * from Ligue2Fr25 UNION select * from Ligue1FrNat25 UNION select * from Ligue1Fr25 UNION select * from BundasLiga25 UNION select * from Bundas2Liga25 UNION select * from Bundes325 UNION select * from Laliga25 UNION select * from Laliga225 UNION select * from Epl25 UNION select * from MalaysiaPrem25 UNION select * from BulgariaPrem25 UNION select * from belgiumJpl25 UNION select * from BelgiumChall25 UNION select * from serieBB25  UNION select * from IranPrem25 UNION select * from SaudiPrem25 UNION select * from PolandA25 UNION select * from PolandB25 UNION select * from SerbiaA25 UNION select * from DenmarkA25 UNION select * from DenmarkB25"
# insert_stmt2 = "select * from PeruA25 UNION select * from CzechB25 UNION select * from CzechA25 UNION select * from SlovakiaA25 UNION select * from SlovakiaB25 UNION select * from BrazilA25 UNION select * from SwissChalleng25 UNION select * from SwitzerA25 UNION select * from QaterPrem25 UNION select * from UkrainePresha25 UNION select * from UkraineA25 UNION select * from serieBB25 UNION select * from Ligue2Fr25 UNION select * from Ligue1FrNat25 UNION select * from Ligue1Fr25 UNION select * from BundasLiga25 UNION select * from Bundas2Liga25 UNION select * from Bundes325 UNION select * from Laliga25 UNION select * from Laliga225 UNION select * from Epl25 UNION select * from MalaysiaPrem25 UNION select * from BulgariaPrem25 UNION select * from belgiumJpl25 UNION select * from BelgiumChall25 UNION select * from serieBB25  UNION select * from NorwayA25 UNION select * from SaudiPrem25 UNION select * from PolandA25 UNION select * from PolandB25 UNION select * from SerbiaA25 UNION select * from DenmarkA25 UNION select * from DenmarkB25" 
# insert_stmt2 = "select * from PeruA25  UNION select * from EngLeagua225 UNION select * from EplChampionShip25   UNION select * from EngLeagua125 UNION select * from NorwayB25 UNION select * from Austria225 UNION select * from RomaniA25 UNION select * from Austria125 UNION select * from icelandBesta25 UNION select * from icelandDiv125 UNION select * from CzechB25 UNION select * from csuper25 UNION select * from CzechA25 UNION select * from SlovakiaA25 UNION select * from SlovakiaB25 UNION select * from SwedenA25 UNION select * from SwedenB25 UNION select * from BrazilA25 UNION select * from SwissChalleng25 UNION select * from SwitzerA25 UNION select * from QaterPrem25 UNION select * from UkrainePresha25 UNION select * from UkraineA25 UNION select * from serieBB25 UNION select * from 
#  UNION select * from Ligue1FrNat25 UNION select * from Ligue1Fr25 UNION select * from BundasLiga25 UNION select * from Bundas2Liga25 UNION select * from Bundes325 UNION select * from Laliga25 UNION select * from Laliga225 UNION select * from Epl25 UNION select * from MalaysiaPrem25 UNION select * from BulgariaPrem25 UNION select * from belgiumJpl25 UNION select * from BelgiumChall25 UNION select * from serieBB25  UNION select * from NorwayA25 UNION select * from SaudiPrem25 UNION select * from PolandA25 UNION select * from PolandB25 UNION select * from SerbiaA25 UNION select * from DenmarkA25 UNION select * from DenmarkB25" 
insert_stmt2 = "Select * FROM portLeag25 union Select * FROM SwissChalleng25 union Select * FROM SwitzerA25 union Select * FROM Turk25 union Select * FROM Turk225 union Select * FROM SloveniaA2025 union Select * FROM BelgiumChall25 union Select * FROM SwedenB25 union Select * FROM BrazilA25 union Select * FROM SwedenA25 union Select * FROM SloveniaB25 union Select * FROM MalaysiaPrem25 union Select * FROM Eredevisie25 union Select * FROM CroatiaB25 union Select * FROM  portLeag225 union Select * FROM  pslA2025 union Select * FROM  RomaniA25 union Select * FROM  RomaniB25 union Select * FROM  ScotlandA25  union Select * FROM  SerbiaA25 union Select * FROM  SerieA25 union Select * FROM  SerieBB25 union Select * FROM  SingPorePrem25 union Select * FROM  skleague125 union Select * FROM  SlovakiaAA25 union Select * FROM  SlovakiaB25 union select * from SerbiaB25 union select * from AzerBaijan2025"

#"Austria125  UNION select * from  CroatiaA25 UNION select * from SwitzerA25 UNION select * from  CroatiaB25  UNION select * from Austria225 UNION select * from belgiumJpl25   UNION select * from BrazilA25 UNION select * from BulgariaPrem25 UNION select * from Bundas2Liga25 UNION select * from Bundes325 UNION select * from CroatiaA25 UNION select * from CSuper25 UNION select * from CzechA25 UNION select * from CzechB25 UNION select * from DenmarkA25 UNION select * from DenmarkB25 UNION select * from EngLeagua225 UNION select * from EngLeagua125 UNION select * from EstoniaPrem25  UNION select * from irelandPrem25 UNION select * from JordanPrem25 UNION select * from PolandA25 UNION select * from PolandB25 UNION select * from RomaniA25  UNION select * from SlovakiaB25  UNION select * from SwedenA25 UNION select * from SwedenB25 UNION select * from SwissChalleng25 UNION select * from UkraineA25 UNION select * from UkrainePresha25 UNION select * from SloveniaA2025" 
...
def createReport(data1,pd):
 ...
 #with pd.ExcelWriter('awaystreaks.xlsx') as writer:
  ...
  df.to_excel('StreaksAwayinfo2.xlsx', sheet_name="Away", index=False)
  #for ee in data1:
